...
function Review(props) {
    const { rating, title, review, createAt, avatarUser } = props.review;
        ...
        <View style={styles.viewReview}>
            ...
            <View style={styles.viewInfo}>
                ...
                <Text style={styles.reviewDate}>
                    {createReview.getDate()}/{createReview.getMonth() +1 < 10 ? "0" : ""}{createReview.getMonth() +1}/{createReview.getFullYear()}
                    {" "}-{" "} 
